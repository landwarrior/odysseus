          ...
          <table class="table table-hover">
            <thead class="thead-light">
              <tr class="text-center">
                <th scope="col">{{ __('messages.project.no') }}</th>
                <th scope="col">{{ __('messages.project.name') }}</th>
                <th scope="col">{{ __('messages.project.order_amount') }}</th>
                <th scope="col">{{ __('messages.project.from') }}</th>
                <th scope="col">{{ __('messages.project.to') }}</th>
                <th scope="col">{{ __('messages.project.assign') }}</th>
              </tr>
            </thead>
            <tbody>
              @if(count($projects) == 0)
              ...
              <tr class="text-center" data-href="/project/{{ $project->project_no }}" style="z-index: -1">
                ...
                <td class="text-center">
                  <button type="button" class="btn btn-primary" data-href="/projecthr/{{ $project->project_no }}" style="z-index:9">

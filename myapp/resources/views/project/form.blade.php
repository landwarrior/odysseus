            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" id="order_amount" class="form-control numFmt @error('order_amount') is-invalid @enderror" name="order_amount" value="{{ old('order_amount', $project->order_amount) }}" placeholder="{{ __('messages.project.order_amount') }}">
                                <label for="order_amount">{{ __('messages.project.order_amount') }}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" id="from_date" class="form-control datepicker @error('from_date') is-invalid @enderror" name="from_date" value="{{ $project->from_date }}" placeholder="{{ __('messages.project.from') }}">
                                <label for="from_date">{{ __('messages.project.from') }}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" id="to_date" class="form-control datepicker @error('to_date') is-invalid @enderror" name="to_date" value="{{ $project->to_date }}" placeholder="{{ __('messages.project.to') }}">
